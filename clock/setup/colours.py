...
FOREST_GREEN = graphics.Color(34,139,34)
SEA_GREEN = graphics.Color(60,179,113)
...
MIDDLE_PURPLE = graphics.Color(147,112,219)
ROYAL_PURPLE = graphics.Color(120,81,169)
